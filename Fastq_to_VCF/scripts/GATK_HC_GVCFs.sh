...
-allSites
#### $(for i in {01..38} X MT; do echo "-V 2nd_call_cat_samt_ug_hc_bushDog_chr$i.g.vcf.gz";done) \
#### -o ${HCvcf}/2nd_call_cat_samt_ug_hc_Bushdog_chrALLchr.g.vcf.gz \
## -allSites
...
${HCvcf}/2nd_call_cat_samt_ug_hc_ManedW_chr01.g.vcf.gz
